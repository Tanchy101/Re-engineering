        ...
        <div class="col">
          <div class="card shadow" style="margin-top: -37em; max-height: 43em; padding: 1em;">
            <div class="card-header border-6">
              <h3>Customize your Layout: 5x11 Dimension</h3>
            </div>
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 143mm; width: 311mm;">
                        <p>5x11</p>
                      </div>
                      <div class = "row">
                  ...
                  <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 104em; margin-top: -120px; 
                        height: 120px; background-color: transparent; border: none;">
