            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 83px; margin-left: -119px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 80px; margin-left: 21px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 253px; margin-left: -119px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 250px; margin-left: 21px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 83px; margin-left: 378px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 80px; margin-left: 517px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 253px; margin-left:  378px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 250px; margin-left: 517px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 533px; margin-left: -119px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 530px; margin-left: 21px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 703px; margin-left: -119px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 700px; margin-left: 21px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 533px; margin-left: 378px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 530px; margin-left: 517px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 703px; margin-left:  378px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 700px; margin-left: 517px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-left: 641px; margin-top: 853px;;  z-index:2">
                       ...
                       <!-- Computers --> 
                       <div class="drag-element" style = "margin-top: 108px; margin-left: -60px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                        <div class="drag-element" style = "margin-top: 278px; margin-left: -60px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                       
                       <div class="drag-element" style = "margin-top: 138px; margin-left: 15px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>     
                                                                         
                        <div class="drag-element" style = "margin-top: 298px; margin-left: 15px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  
                        ...
                        <div class="drag-element" style = "margin-top: 108px; margin-left: 435px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                        <div class="drag-element" style = "margin-top: 278px; margin-left: 435px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                       
                       <div class="drag-element" style = "margin-top: 138px; margin-left: 510px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>     
                                                                         
                        <div class="drag-element" style = "margin-top: 298px; margin-left: 510px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  
                        ...
                        <div class="drag-element" style = "margin-top: 558px; margin-left: -60px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                        <div class="drag-element" style = "margin-top: 728px; margin-left: -60px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                       
                       <div class="drag-element" style = "margin-top: 588px; margin-left: 15px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>     
                                                                         
                        <div class="drag-element" style = "margin-top: 748px; margin-left: 15px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  
                        ...
                        <div class="drag-element" style = "margin-top: 558px; margin-left: 435px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                        <div class="drag-element" style = "margin-top: 728px; margin-left: 435px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                       
                       <div class="drag-element" style = "margin-top: 588px; margin-left: 510px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>     
                                                                         
                        <div class="drag-element" style = "margin-top: 748px; margin-left: 510px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  
                        ...
                        <!-- Chairs -->
                        <div class="drag-element" style = "z-index:3; margin-top: 110px; margin-left: -105px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                        <div class="drag-element" style = "z-index:3; margin-top: 280px; margin-left: -105px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>    

                      <div class="drag-element" style = "z-index:3; margin-top: 145px; margin-left: 75px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                      <div class="drag-element" style = "z-index:3; margin-top: 308px; margin-left: 75px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>  
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 110px; margin-left: 390px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                        <div class="drag-element" style = "z-index:3; margin-top: 280px; margin-left: 390px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>    

                      <div class="drag-element" style = "z-index:3; margin-top: 145px; margin-left: 570px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                      <div class="drag-element" style = "z-index:3; margin-top: 308px; margin-left: 570px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>  
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 560px; margin-left: -105px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                        <div class="drag-element" style = "z-index:3; margin-top: 730px; margin-left: -105px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>    

                      <div class="drag-element" style = "z-index:3; margin-top: 595px; margin-left: 75px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                      <div class="drag-element" style = "z-index:3; margin-top: 758px; margin-left: 75px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>  
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 560px; margin-left: 390px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                        <div class="drag-element" style = "z-index:3; margin-top: 730px; margin-left: 390px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>    

                      <div class="drag-element" style = "z-index:3; margin-top: 595px; margin-left: 570px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>     
                            
                      <div class="drag-element" style = "z-index:3; margin-top: 758px; margin-left: 570px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>  
