          ...
          <div class="card shadow">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 255mm; width: 311mm; margin-left: -200px">
                      <p></p>
                    ...
                    <!-- Tables -->
                      ...
                      <div class="drag-element" style = "margin-top: 648px; margin-left: 402px;;  z-index:2">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                      </div>
                      ...
                      <div class="drag-element" style = "margin-top: 651px; margin-left: 840px;;  z-index:2">
                       ...
                       <!-- Door -->
                      <div class="drag-element" style = "margin-left: 340px; margin-top: 851px;;  z-index:2">
                      ...
                      <div class="drag-element" style = "margin-top: 675px; margin-left: 310px;  z-index:4" >
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
