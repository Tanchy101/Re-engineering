          ...
          <div class="card shadow">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 171mm; width: 199mm; margin-left:-100px">
                        <p>6x7</p>
                      </div>
                    </div> 
                    ...
                    <div class = "row">
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 1160px; margin-top: -120px; height: 120px;">
