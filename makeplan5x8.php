        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-6">
              <h3>Customize your Layout: 5x8 Dimension</h3>
            </div>
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 143mm; width: 227mm; margin-left:-150px">
                        <p>5x8</p>
                      </div>
                    </div> 
                    ...
                    <div class = "row">
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 1230px; margin-top: -120px; height: 120px;">
