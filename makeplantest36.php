      ...
      <div class="card shadow" style="margin-top: -18em;">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              ...
              <div class="col-sm-5" style = "padding-right: 150px; padding-left: 30px; max-width:480px" > <b style = "margin-top: 10px;"> ITEMS TO ADD: </b>
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 283mm; width: 283mm; margin-left: -200px; margin-top: 15px">
                      <p></p>
                    ...
                    <div class="drag-element" style = "z-index:2; margin-left: 608px; margin-top: 65px;">
                      ...
                      <div class="drag-element" style = "z-index:2; margin-left:  698px; margin-top: 498px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>  
                      ...
                      <div class="drag-element" style = "margin-left: 765px; margin-top: 13px;;  z-index:2">
                    ...
                    <!-- Computers 6th row-->
                     ...
                     <div class="drag-element" style = "margin-top: 55px; margin-left: 625px; z-index:4">
                      ...
                      <div class="drag-element" style = "margin-top: 505px; margin-left: 730px; z-index:4">
                        ...
                        <div class="drag-element" style = "z-index:3; margin-top: 502px; margin-left: 795px">
                    ...
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 4em; margin-top: -120px; 
                      ...
                      <!-- </div> -->
                    <!-- </div> -->
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 86em; margin-top: -120px; 
                          height: 120px; background-color: transparent; border: none;">
