        ...
        <div class="col">
          <div class="card shadow" style="margin-top: -37em; max-height: 43em; padding: 1em;">
            <div class="card-header border-6">
              <h3>Customize your Layout: 6x9 Dimension</h3>
            </div>
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 171mm; width: 255mm;">
                        <p>6x9</p>
                      </div>
                      <div class = "row">
                  ...
                  <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 91em; margin-top: -120px; 
                        height: 120px; background-color: transparent; border: none;">
