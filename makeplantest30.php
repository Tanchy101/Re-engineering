          ...
          <div class="card shadow">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 283mm; width: 171mm; margin-left: -50px">
                      <p></p>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-left: 215px; margin-top: 885px;">
                      ...
                      <div class="drag-element" style = "margin-left: 455px; margin-top: 958px;;  z-index:2">
                      ...
                      <div class="drag-element" style = "margin-top: 895px; margin-left: 230px; z-index:4">
                       ...
                       <div class="drag-element" style = "z-index:3; margin-top: 17px; margin-left: 136px">
                        ...
                        <div class="drag-element" style = "z-index:3; margin-top: 952px; margin-left: 232px">
                      ...
                      <div class="drag-element" style = "margin-top: 955px; margin-left: -40px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 955px; margin-left: 555px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top:848px; margin-left: 255px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 1009px; margin-left: -36px; z-index:4">
