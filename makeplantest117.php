      ...
      <div class="card shadow" style="margin-top: -18em;">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 283mm; width: 255mm; margin-left: -200px; margin-top: 23px">
                      <p></p>
                      ...
                      <div class="drag-element" style = "z-index:3; margin-left: 200px; margin-top: 1025px;">
                    ...
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 6em; margin-top: -120px; 
                      ...
                      <!-- </div> -->
                    <!-- </div> -->
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 83em; margin-top: -120px; 
                          height: 120px; background-color: transparent; border: none;">
