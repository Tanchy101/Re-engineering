            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="drag-element" style = "z-index:1; margin-left: 13px; margin-top:568px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 230px; margin-top:-2px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 230px; margin-top:568px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:1; margin-left: 450px; margin-top:568px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>
                       ...
                       <div class="drag-element" style = "z-index:2; margin-top: 94px; margin-left: -15px">
                        ...
                        <div class="drag-element" style = "z-index:2; margin-top: 94px; margin-left: 205px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>

                        <div class="drag-element" style = "z-index:2; margin-top: 94px; margin-left: 425px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>

                        <div class="drag-element" style = "z-index:2; margin-top: 664px; margin-left: -15px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>

                          <div class="drag-element" style = "z-index:2; margin-top: 664px; margin-left: 205px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>

                          <div class="drag-element" style = "z-index:2; margin-top: 664px; margin-left: 425px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element"  style = "margin-top: 147px; margin-left: 295px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 147px; margin-left: 515px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 714px; margin-left: 75px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 714px; margin-left: 295px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 714px; margin-left: 515px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>
                    ...
                    <!-- Door -->
                    <div class="drag-element" style = "margin-left: 555px; margin-top: 390px;;  z-index:2">
                    ...
                    <!-- Computers -->
                      <div class="drag-element" style = "margin-top: 708px; margin-left: 6px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 708px; margin-left: 226px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 708px; margin-left: 446px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 137px; margin-left: 226px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top:137px; margin-left: 446px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <!-- Others -->
                       <div class="drag-element" style = "margin-top: 340px; margin-left: 10px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 380px; margin-left: 8px; z-index:4">
                              <div class="rect"><img src="assets/img/items/router.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -6px; padding-left: 100px; margin-top: -7px"> <b>Router </b></div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 450px; margin-left: -28px; z-index:4">
