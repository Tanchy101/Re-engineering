 ...
 <?php
  ...
  <div class="main-content">
    ...
    <div style="background-image: url(assets/img/theme/GenerateBG.png); background-size: cover; height: 100vh;" class="header  pb-8 pt-5 pt-md-8">
     <span class="mas bg-gradient-dark opacity-5"></span>
      ...
      <div class="row">
        ...
        <div class="card shadow" style="margin-top: -37em; max-height: 43em; padding: 1em;">
            <div class="card-header border-6">
              <h3>Customize your Layout: 9x10 Dimension</h3>
            </div>
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                   <div class="col-sm-5" style = "padding-right: 150px; padding-left: 30px; max-width:480px" > <b style = "margin-top: 10px;"> ITEMS LIST: </b>
                      <div id = "accordion">   
                    ...
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 255mm; width: 283mm;">
                        <p>9x10</p>
                      </div>
                      <div class = "row">
                  ...
                  <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 98.5em; margin-top: -120px;  
                        height: 120px; background-color: transparent; border: none;">
