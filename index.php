...
<body class="bg-image" style="display: flex; overflow: hidden; background-image: url('assets/img/brand/Index BG.png'); background-size: cover">
        <div class="nlas" style="position: fixed; top: 45%; left: 25%; color: white; font-size: 20px; text-align: center;">Network Layout<br>Assessment System</div>
        <div class="text" style="position: fixed; top: 2%; left: 1%; color: white; font-size: 20px; font-family: 'Montserrat'; font-weight: bold;">Log In</div>
            <div class="container" style="margin-left: 1000px; margin-bottom: 0px; margin-top: 150px;">
