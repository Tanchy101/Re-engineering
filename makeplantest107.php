          ...
          <div class="card shadow">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 283mm; width: 227mm; margin-left:-120px">
                      <p></p>
                      ...
                      <div class="drag-element" style = "margin-left: 641px; margin-top: 960px;;  z-index:2">
                    ...
                    <div class = "row">
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 9em; margin-top: -120px; 
                      ...
                      <!-- </div> -->
                    <!-- </div> -->
                    <div class ="elementToOverlay2 col-sm-2 dropzone element-trash" style = "margin-left: 79em; margin-top: -120px; 
                          height: 120px; background-color: transparent; border: none;">
