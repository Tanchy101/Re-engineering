      ...
      <div class="card shadow" style="margin-top: -18em;">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              ...
              <div class="col-sm-5" style = "padding-right: 150px; padding-left: 30px; max-width:480px" > <b style = "margin-top: 10px;"> ITEMS TO ADD: </b>
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 255mm; width: 171mm; margin-left: -50px">
                      <p></p>
                      ...
                      <div class="drag-element" style = "margin-left: 455px; margin-top: 852px;;  z-index:2">
                      ...
                      <div class="drag-element" style = "margin-top: 0px; margin-left: 95px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 0px; margin-left: 415px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 889px; margin-left: -35px; z-index:4">
