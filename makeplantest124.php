            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <!-- Cubicles -->
                      <div class="drag-element" style = "z-index:1; margin-left: 13px; margin-top: -2px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 233px; margin-top: -2px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 450px; margin-top: -2px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:1; margin-left: 13px; margin-top: 430px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 233px; margin-top: 430px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:1; margin-left: 13px; margin-top: 885px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 233px; margin-top: 885px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:1; margin-left: 450px; margin-top: 885px">
                              <div class="rect"><img src="assets/img/items/U-shaped_cubicle.png" draggable="false" />
                              <div class="middle desc" style = "margin-left:70px; margin-top: 90px"> <b>U-shape Cubicle </b> <br>260cmX185cm</div>
                            </div>
                            </div>
                       ...
                       <div class="drag-element" style = "z-index:2; margin-top: 19px; margin-left: 23px">
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 19px; margin-left: 243px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>

                        <div class="drag-element" style = "z-index:2; margin-top: 19px; margin-left: 463px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 450px; margin-left: 23px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 450px; margin-left: 243px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 983px; margin-left: -13px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 983px; margin-left: 209px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>

                        <div class="drag-element" style = "z-index:2; margin-top: 983px; margin-left: 424px">
                              <div class="rect"><img src="assets/img/items/U-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 75px; margin-top: 50px"> <b>U-shaped Table </b> <br>195cmX155cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element"  style = "margin-top: 67px; margin-left: 65px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 67px; margin-left: 285px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 67px; margin-left: 505px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>
                      ...
                      <div class="drag-element"  style = "margin-top: 497px; margin-left: 65px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 497px; margin-left: 285px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>
                      ...
                      <div class="drag-element"  style = "margin-top: 1027px; margin-left: 75px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" />
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top: 1027px; margin-left: 295px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" />
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>

                      <div class="drag-element"  style = "margin-top:1027px; margin-left: 515px;  z-index:3">
                              <div class="rect"><img src="assets/img/items/office_chair.png" draggable="false" />
                              <div class="middle desc" style = "color:whitesmoke; margin-top: 0px; margin-left:8px"> <b >Office Chair </b> <br>63cmX66cm</div>
                              </div>
                      </div>
                    ...
                    <!-- Door -->
                    <div class="drag-element" style = "margin-left: 555px; margin-top: 535px;;  z-index:2">
                    ...
                    <!-- Computers -->
                      <div class="drag-element" style = "margin-top: 58px; margin-left: 130px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 58px; margin-left: 350px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 58px; margin-left: 570px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 490px; margin-left: 130px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 490px; margin-left: 350px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 1020px; margin-left: 5px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top:1020px; margin-left: 230px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top:1020px; margin-left: 445px;  z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <!-- Others -->
                    <div class="drag-element" style = "margin-top: 340px; margin-left: 15px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 380px; margin-left: 12px; z-index:4">
                              <div class="rect"><img src="assets/img/items/router.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -6px; padding-left: 100px; margin-top: -7px"> <b>Router </b></div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-left: -28px; margin-top: 740px;">
                              <div class="rect"><img src="assets/img/items/cabinet3.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 45px;margin-top: 10px; color:white"> <b> File Cabinet </b> <br>99cmX56cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3;margin-left: 10px; margin-top: 263px;">
                              <div class="rect"><img src="assets/img/items/cabinet.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 4px; margin-top: 0px"> <b>File Cabinet</b> <br>43cmX52cm</div>
                              </div>
                            </div>
