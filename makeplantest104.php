            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="drag-element" style = "z-index:2; margin-top: 60px; margin-left: 555px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 60px; margin-left: 385px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 60px; margin-left: 215px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 60px; margin-left: 45px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 200px; margin-left: 555px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 200px; margin-left: 385px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 200px; margin-left: 215px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-top: 200px; margin-left: 45px">
                              <div class="rect"><img src="assets/img/items/L-table.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 74px; margin-top: 55px;"> <b>L-shaped Table </b> <br>155cmX130cm</div>
                              </div>
                            </div>
                      ...
                      <!-- Down Tables last side -->

                      <div class="drag-element" style = "z-index:2; margin-left: 540px; margin-top: 690px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 540px; margin-top: 570px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 540px; margin-top: 450px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 475px; margin-top: 690px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 475px; margin-top: 570px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 475px; margin-top: 450px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>
                      ...
                      <!-- Down Tables 2nd side -->

                      <div class="drag-element" style = "z-index:2; margin-left: 290px; margin-top: 690px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 290px; margin-top: 570px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 290px; margin-top: 450px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 225px; margin-top: 690px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 225px; margin-top: 570px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 225px; margin-top: 450px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>
                      ...
                      <!-- Down Tables 1st side -->

                      <div class="drag-element" style = "z-index:2; margin-left: 40px; margin-top: 690px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 40px; margin-top: 570px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 40px; margin-top: 450px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: -25px; margin-top: 690px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: -25px; margin-top: 570px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: -25px; margin-top: 450px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false" style ="transform: rotate(90deg)" />
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-left: -120px; margin-top: -2px;;  z-index:2">
                       ...
                       <!-- Computers -->
                       <div class="drag-element" style = "margin-top: 135px; margin-left: 80px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top:  135px; margin-left: 250px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top:  135px; margin-left: 420px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                                                                                                               
                      <div class="drag-element" style = "margin-top:  135px; margin-left: 595px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 210px; margin-left: 60px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 210px; margin-left: 230px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 210px; margin-left: 400px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                                                                                                               
                      <div class="drag-element" style = "margin-top:210px; margin-left: 575px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  
                      ...
                      <!-- Computer down Rotate -->
                   
                      <div class="drag-element" style = "margin-top: 440px; margin-left: 495px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 560px; margin-left: 495px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 680px; margin-left: 495px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                        ...
                        <div class="drag-element" style = "margin-top: 440px; margin-left: 240px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 560px; margin-left: 240px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 680px; margin-left: 240px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                        ...
                        <div class="drag-element" style = "margin-top: 440px; margin-left: -10px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 560px; margin-left: -10px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 680px; margin-left: -10px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                    ...
                    <!-- Computer down -->
                        ...
                        <div class="drag-element" style = "margin-top: 450px; margin-left: 575px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 570px; margin-left: 575px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 690px; margin-left: 575px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                        ...
                        <div class="drag-element" style = "margin-top: 450px; margin-left: 320px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 570px; margin-left:  320px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 690px; margin-left:  320px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                        ...
                        <div class="drag-element" style = "margin-top: 450px; margin-left: 70px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 570px; margin-left: 70px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>  

                       <div class="drag-element" style = "margin-top: 690px; margin-left: 70px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" />
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 90px; margin-left: 92px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 90px; margin-left: 261px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 90px; margin-left: 431px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                            
                      <div class="drag-element" style = "z-index:3; margin-top: 90px; margin-left: 603px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <!-- Chairs Rotate -->
                      <div class="drag-element" style = "z-index:3; margin-top: 265px; margin-left: 62px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 265px; margin-left: 231px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 265px; margin-left: 401px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                            
                      <div class="drag-element" style = "z-index:3; margin-top:265px; margin-left: 573px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <!-- Chairs Rotate Down -->
                      <div class="drag-element" style = "z-index:3; margin-top: 460px; margin-left: 632px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 580px; margin-left:632px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 700px; margin-left: 632px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 460px; margin-left: 380px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 580px; margin-left:380px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 700px; margin-left: 380px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 460px; margin-left: 130px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 580px; margin-left:130px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 700px; margin-left: 130px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <!-- Chairs Down -->
                      <div class="drag-element" style = "z-index:3; margin-top: 450px; margin-left: 442px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 570px; margin-left:442px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 690px; margin-left: 442px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"style ="transform: rotate(180deg)" />
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 450px; margin-left: 195px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 570px; margin-left:195px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 690px; margin-left: 195px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:3; margin-top: 450px; margin-left: -60px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false"style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 570px; margin-left:-60px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-top: 690px; margin-left: -60px">
                              <div class="rect"><img src="assets/img/items/office_chair2.png" draggable="false" style ="transform: rotate(180deg)"/>
                              <div class="middle desc" style = "color:gray; margin-top: 0px; margin-left: 5px"> <b >Small <br> Office Chair </b> <br>53cmX57cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 801px; margin-left: 555px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 800px; margin-left: 505px; z-index:4">
                              <div class="rect"><img src="assets/img/items/router.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -6px; padding-left: 100px; margin-top: -7px"> <b>Router </b></div>
                              </div>
                            </div>

                      <div class="drag-element" style = "z-index:3; margin-left: -210px; margin-top: 355px;">
