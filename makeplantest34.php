      ...
      <div class="card shadow" style="margin-top: -18em;">
            ...
            <div class = "col-sm-12 container" id = "form-container">
              ...
              <div class="col-sm-5" style = "padding-right: 150px; padding-left: 30px; max-width:480px" > <b style = "margin-top: 10px;"> ITEMS TO ADD: </b>
                    ...
                    <!-- EDIT COLUMN -->
                    <div class="col-sm-6">
                      <div id = "plane-container" style = "height: 283mm; width: 227mm; margin-left: -160px">
                      <p></p>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-left: 215px; margin-top: 905px;">
                      ...
                      <div class="drag-element" style = "margin-left: 555px; margin-top: 959px;;  z-index:2">
                      ...
                      <div class="drag-element" style = "margin-top: 915px; margin-left: 230px; z-index:4">
                       ...
                       <div class="drag-element" style = "z-index:3; margin-top: 17px; margin-left: 273px">
                        ...
                        <div class="drag-element" style = "z-index:3; margin-top: 972px; margin-left: 232px">
                      ...
                      <div class="drag-element" style = "margin-top: 860px; margin-left: 115px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 860px; margin-left: 390px; z-index:4">
                              <div class="rect"><img src="assets/img/items/switch.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: -10px; padding-left: 100px; margin-top: -7px"> <b>Switch </b> </div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 989px; margin-left: -155px; z-index:4">
