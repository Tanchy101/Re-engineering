            ...
            <div class = "col-sm-12 container" id = "form-container">
              ...
              <div class="col-sm-5" style = "padding-right: 150px; padding-left: 30px; max-width:480px" > <b style = "margin-top: 10px;"> ITEMS TO ADD: </b>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="drag-element" style = "z-index:2; margin-left: -5px; margin-top: 963px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>

                      <div class="drag-element" style = "z-index:2; margin-left: 102px; margin-top: 963px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "z-index:2; margin-left: -45px; margin-top: 1035px;">
                              <div class="rect"><img src="assets/img/items/computer_desk.png" draggable="false"/>
                              <div class="middle desc" style = "margin-left: 35px; margin-top: 10px;"> <b>Computer Desk</b> <br>100cmX60cm</div>
                            </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-left: 455px; margin-top: 1064px;;  z-index:2">
                      ...
                      <div class="drag-element" style = "margin-top: 835px; margin-left: 20px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 835px; margin-left: 125px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 955px; margin-left: 20px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 955px; margin-left: 125px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 835px; margin-left: 355px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 835px; margin-left: 460px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                     ...
                     <div class="drag-element" style = "margin-top: 985px; margin-left: 355px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>

                      <div class="drag-element" style = "margin-top: 985px; margin-left: 460px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                      ...
                      <div class="drag-element" style = "margin-top: 1045px; margin-left: -30px; z-index:4">
                              <div class="rect"><img src="assets/img/items/computer.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-left: 0px; margin-top: 0px"> <b>Computer </b> <br>60cmX43cm</div>
                              </div>
                            </div>
                        ...
                        <div class="drag-element" style = "z-index:3; margin-top: 902px; margin-left: 12px">
                              <div class="rect"><img src="assets/img/items/school_chair.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-top: 4px; margin-left:10px"> <b >School Chair</b> <br>42cmX47cm</div>
                              </div>
                            </div>

                        <div class="drag-element" style = "z-index:3; margin-top: 902px; margin-left: 119px">
                              <div class="rect"><img src="assets/img/items/school_chair.png" draggable="false" style ="transform: rotate(-90deg)"/>
                              <div class="middle desc" style = "margin-top: 4px; margin-left:10px"> <b >School Chair</b> <br>42cmX47cm</div>
                              </div>
                            </div>
                        ...
                        <div class="drag-element" style = "z-index:3; margin-top: 1102px; margin-left: -30px">
                              <div class="rect"><img src="assets/img/items/school_chair.png" draggable="false" style ="transform: rotate(90deg)"/>
                              <div class="middle desc" style = "margin-top: 4px; margin-left:10px"> <b >School Chair</b> <br>42cmX47cm</div>
                              </div>
                            </div>
